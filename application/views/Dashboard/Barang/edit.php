	  ...
	  <div class="container-full">
		...
		<section class="content">
			<div class="container-fluid bg-white rounded">
                <?php echo form_open("/dashboard/barang/update/$target_id") ?>
                <div class="p-3">
                    <h3 class="mb-2 fw-bold">📦 Edit Barang</h3>
                    <div class="form-group row">
						<label class="col-form-label col-md-2 my-3">Nama Barang</label>
						<div class="col-md-10 my-3">
							<input class="form-control" type="text" name="nama_barang" value="<?= $data_barang[0]->nama_barang ?>">
                    ...
                    <div class="form-group row">
						...
						<div class="col-md-10 mb-3">
							<input class="form-control" type="number" name="stock" value="<?= $data_barang[0]->stock ?>">
                    ...
                    <div class="form-group row">
						...
						<div class="col-md-10 mb-3">
							<input class="form-control" type="number" name="harga" value="<?= $data_barang[0]->harga ?>">
